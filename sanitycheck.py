...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_get:
        ...
        print(FAIL_COLOR + "\nPlease make sure "
                           "you have a test case for the GET method.\
            This MUST test both the status "
                           "code as well as the contents of"
                           " the request object.\n")
    ...
    if not test_functions_for_post:
        ...
        if len(test_functions_for_post) == 1:
            ...
            print(FAIL_COLOR + "Please make sure you"
                               " have two test cases for"
                               " the POST() method." +
                  "\nOne test case for EACH of "
                  "the possible inferences (results/outputs)"
                  " of the ML model.\n")
            SANITY_TEST_PASSING = False
        ...
        if len(
            ...
            print(
                FAIL_COLOR +
                "You do not seem to have TWO separate "
